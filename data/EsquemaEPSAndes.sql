...
CREATE TABLE EPS(
  ...
  ID_CAMPAÑA NUMBER UNIQUE,--
  CONSTRAINT EPS_PK PRIMARY KEY (ID),
  CONSTRAINT FK_E_CAMPAÑA FOREIGN KEY (ID_CAMPAÑA) REFERENCES CAMPAÑA(ID)--
); 
...
CREATE TABLE HORARIO(
  ...
  CONSTRAINT FK_H_CAMPAÑA FOREIGN KEY (ID_CAMPAÑA) REFERENCES CAMPAÑA(ID),--
...
CREATE TABLE USUARIO(
  ...
  CONSTRAINT CHK_TIPO_USUARIO CHECK(TIPO_USUARIO IN ('ADMINISTRADOR', 'RECEPCIONISTA', 'GERENTE', 'MEDICO', 'PACIENTE', 'ORGANIZADOR CAMPAÑA'))--
);
...
CREATE TABLE PACIENTE(
  ...
  CONSTRAINT FK_P_CAMPAÑA FOREIGN KEY (ID_CAMPAÑA) REFERENCES CAMPAÑA(ID),--
