...
CREATE TABLE SERVICIO(
  ID NUMBER,
  --BORRADO ID ORDEN, ID HORARIO, CAPACIDAD
  NOMBRE VARCHAR(255),
  ...
  CONSTRAINT CHK_SERVICIO CHECK(RESERVADO IN ('S', 'N') AND INHABILITADO IN ('S' , 'N'))  --SE BORRA EL CHECK DE CAPACIDAD
);
...
CREATE TABLE IPS_SERVICIOS(
  ...
  CONSTRAINT CHK_IP_SER_CAN CHECK (CAPACIDAD > 0)
);
