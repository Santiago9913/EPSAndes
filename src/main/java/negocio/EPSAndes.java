...
public class EPSAndes {
	...
	public Paciente registrarPaciente(String id, String nombre, String correo, Timestamp fNac, String estado, String tipoDoc) {
	...
	public Medico registrarMedico(String id, String nombre, String correo, String especialidad, int numRegistro) {
		...
		Medico med = ep.registrarMedico(id, nombre, correo, especialidad, numRegistro);
		log.info("Registrando médico: " + med);
		return med;
	}
	
	public Secretaria registrarRecepcionista(String id, String nombre, String correo) {
		log.info("Registrando secretaria: " + nombre);
		Secretaria sec = ep.registrarSecretaria(id, nombre, correo);
		log.info("Registrando secretaria: " + sec);
		return sec;
	}
	
	public Administrador registrarAdministrador(String id, String nombre, String correo) {
		log.info("Registrando administrador: " + nombre);
		Administrador admin = ep.registrarAdministrador(id, nombre, correo);
		log.info("Registrando administrador: " + admin);
		return admin;
	}
	
	public Gerente registrarGerente(String id, String nombre, String correo) {
	...
	public IPS registrarIPS(String nombre, String localizacion, int cantidad) {
		...
		IPS ips = ep.registrarIPS(nombre, localizacion, cantidad);
	...
	public Servicio registrarServicio(int capacidad, List<Horario> horarios, String nombre) {
		...
		Servicio ser = ep.registrarServicio(capacidad, horarios, nombre);
